App.DummyChart = (function() {
	return {
		init: function() {
			document.querySelector('#chart-warp').style.display = 'block';
			document.querySelector('#main-warp').style.display = 'none';
			...
			chart.data = [{ 'name': 'B', 'value': 40, 'disabled': true }, { 'name': 'A', 'value': 60 }];
